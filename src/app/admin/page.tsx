...
const cards = [
  [Users, "Total customers", "users", "/admin/users", "from-blue-600 to-blue-800"],
    ...
    <div className="mx-auto max-w-[1500px]">
      ...
      <section className="mt-7 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
        {cards.map(([Icon, label, key, href, gradient], index) => (
          <Link href={href} key={key} className="group relative overflow-hidden rounded-2xl border border-[#dfe5ef] bg-white p-5 shadow-[0_12px_35px_rgba(16,35,63,.055)] transition hover:-translate-y-1 hover:shadow-[0_18px_45px_rgba(16,35,63,.11)]">
      ...
      <section className="mt-7 grid gap-6 xl:grid-cols-[1.35fr_.65fr]">
        <div className="rounded-3xl border border-[#dfe5ef] bg-white p-6 shadow-[0_12px_35px_rgba(16,35,63,.05)] sm:p-7">
